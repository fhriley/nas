...
if __name__ == '__main__':
    ...
    parser.add_argument('--dc-default', type=lambda xx: ranged_int(xx, MIN_DC, MAX_DC), default=11,
                        help='the default duty cycle when starting up (default: 11)')
    parser.add_argument('--dc-min', type=lambda xx: ranged_int(xx, MIN_DC, MAX_DC), default=11,
                        help='the minimum duty cycle for the disk pid loop (default: 11)')
